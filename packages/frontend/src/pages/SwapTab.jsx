    ...
    <div className="fixed inset-0 z-[90] flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="p-8 text-center">
          ...
          <p className="text-xs text-white/30 mb-6 leading-relaxed">{subtitle}</p>
          <input
            type="password"
            inputMode="numeric"
            maxLength="4"
      ...
      <div className="p-8">
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="p-4 rounded-xl bg-white/[0.03] border border-white/[0.06]">
            <p className="text-xs font-black text-white/40 mb-1">
              ⚠️ This swap only
            </p>
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={onSkip}
            className="py-3.5 px-4 rounded-xl border border-white/10 text-white/40 font-bold text-sm hover:bg-white/5 transition-all"
          >
            Skip
          </button>
          <button
...
const SwapModal = ({ pool, section, user, onClose, showMsg, onSwapComplete }) => {
  ...
  const inputTokenLabel = section === "buy" ? "NGNs" : stableToken;
  const outputTokenLabel = section === "buy" ? stableToken : "NGNs";
              ...
              >
                      ...
                      <button
                        ...
                        className={`flex-1 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest border transition-all ${
                          swapType === id
                            ...
                            : "border-white/[0.06] bg-white/5 text-white/25 hover:text-white/50"
                        }`}
                      >
                        {label}
                      </button>
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <button
                    ...
                    disabled={amountRaw <= 0 || !trustChecked || isBelowMin}
      ...
      <div className="p-5">
        ...
        {section === "buy" ? (
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            ...
            <div className="p-3 rounded-xl bg-white/[0.04] border border-white/[0.06]">
              <p className="text-[9px] uppercase tracking-[0.3em] text-white/40 font-black mb-1">
                cNGN
              </p>
    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-shrink-0 mt-1">
          {lastTime && (
            <p className="text-[9px] text-white/20 font-bold uppercase tracking-widest hidden sm:block">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-white/[0.03] border border-white/[0.06] text-sm text-white placeholder:text-white/20 focus:outline-none focus:border-salvaGold/30 transition-all"
        />
        {search && (
          <button
            onClick={() => setSearch("")}
            className="absolute right-4 top-1/2 -translate-y-1/2 text-white/20 hover:text-white/60 transition-colors text-xs font-black"
          >
            ✕
          </button>
        )}
      ...
      {loading ? (
        ...
        >
          ...
          <p className="font-black text-white/30 text-sm">
            {search
