...
const AdminPanelInner = ({ user, showMsg }) => {
  ...
  const setCancel = (type, val) => setCancelForms((p) => ({ ...p, [type]: val }));
  ...
  const fetchProposals = useCallback(async () => {
    ...
    try {
      ...
      setProposals({
        ...
        upgradeProposals: Array.isArray(data.upgradeProposals) ? data.upgradeProposals : [],
        ...
        implUpdateProposals: Array.isArray(data.implUpdateProposals)
          ...
          : [],
        unpauseProposals: Array.isArray(data.unpauseProposals) ? data.unpauseProposals : [],
      });
    } catch (e) {
      ...
      <div className="rounded-3xl overflow-hidden border border-salvaGold/20 bg-salvaGold/[0.03]">
        ...
        <div className="p-6 space-y-5">
          ...
          <Toggle
            ...
            onChange={() => setRegForm({ ...regForm, isWallet: !regForm.isWallet })}
          />
          <ActionBtn
            spinning={loading}
      ...
      <div className="rounded-3xl overflow-hidden border border-blue-500/20 bg-blue-500/[0.02]">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <Input
                ...
                onChange={(e) => setUpgradeForm({ ...upgradeForm, proxy: e.target.value })}
                mono
            ...
            <Field label="New Implementation">
              <Input
                ...
                onChange={(e) => setUpgradeForm({ ...upgradeForm, newImpl: e.target.value })}
                mono
              />
            </Field>
          </div>
          ...
          <ActionBtn
            ...
            fullWidth
            disabled={
              loading || !upgradeForm.newImpl || (!upgradeForm.isMultisig && !upgradeForm.proxy)
            }
            onClick={() =>
              requestPin(async (pk) => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="RegistryFactory Proxy">
              <Input
                ...
                onChange={(e) => setSignerForm({ ...signerForm, proxy: e.target.value })}
                mono
              />
            </Field>
            <Field label="New Signer Address">
              <Input
                ...
                onChange={(e) => setSignerForm({ ...signerForm, newSigner: e.target.value })}
                mono
              />
            </Field>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="RegistryFactory Proxy">
              <Input
                ...
                onChange={(e) => setImplForm({ ...implForm, proxy: e.target.value })}
                mono
              />
            </Field>
            <Field label="New Implementation">
              <Input
                ...
                onChange={(e) => setImplForm({ ...implForm, newImpl: e.target.value })}
                mono
              />
            </Field>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="RegistryFactory Proxy">
              <Input
                placeholder="0x…"
                value={feeForm.proxy}
                onChange={(e) => setFeeForm({ ...feeForm, proxy: e.target.value })}
                mono
              />
            </Field>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Target Contract">
              <Input
                ...
                onChange={(e) => setPauseForm({ ...pauseForm, proxy: e.target.value })}
                mono
              />
            </Field>
            <Field label="Mark">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Target Contract">
              <Input
                ...
                onChange={(e) => setUnpauseForm({ ...unpauseForm, proxy: e.target.value })}
                mono
              />
            </Field>
            <Field label="Mark">
        ...
        <div className="p-6 space-y-5">
          ...
          <Field label="Singleton Proxy Address">
            <Input
              ...
              onChange={(e) => setWithdrawForm({ ...withdrawForm, singleton: e.target.value })}
              mono
            />
          </Field>
          ...
          <Field label="Receiver Address">
            <Input
              ...
              onChange={(e) => setWithdrawForm({ ...withdrawForm, receiver: e.target.value })}
              mono
            />
          </Field>
          <ActionBtn
            ...
            variant="danger"
            disabled={
              loading || !withdrawForm.singleton || !withdrawForm.token || !withdrawForm.receiver
            }
            onClick={() =>
              requestPin(async (pk) => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Target Address">
              <Input
                ...
                onChange={(e) => setRecoveryForm({ ...recoveryForm, address: e.target.value })}
                mono
              />
            </Field>
            <Field label="Action">
              <ActionSelector
                ...
                onChange={(v) => setRecoveryForm({ ...recoveryForm, action: v })}
              />
            </Field>
          </div>
          <ActionBtn
            spinning={loading}
            label={loading ? 'Updating…' : `${recoveryForm.action ? 'Grant' : 'Revoke'} Recovery`}
            fullWidth
            ...
            onClick={() =>
              requestPin(async (pk) => {
                ...
                showMsg(`Recovery ${recoveryForm.action ? 'granted' : 'revoked'}!`);
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center px-4">
            ...
            >
              ...
              <input
                ...
                onKeyDown={(e) =>
                  e.key === 'Enter' && adminPin.length === 4 && executePinnedAction()
                }
                placeholder="••••"
                autoFocus
  ...
  return (
    <div className="flex flex-wrap gap-2 pt-1">
      ...
      <ActionBtn
        ...
        onClick={onExecute}
      />
      <ActionBtn label="Cancel" variant="danger" disabled={loading} onClick={onCancel} />
