    ...
    <div ref={ref} className="relative">
      ...
      >
        {value ? (
          ...
          <span className="text-sm text-white/25 font-bold">{placeholder}</span>
        )}
        ...
        {open && (
          ...
          >
            <div className="p-3 border-b border-white/[0.05]">
              <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent outline-none text-xs font-bold placeholder:text-white/20 text-white"
                />
                {query && (
                  <button
                    type="button"
                    onClick={() => setQuery("")}
                    className="text-white/25 hover:text-white/60 text-[10px]"
                  >
                    ✕
                  </button>
                )}
            ...
            <div style={{ maxHeight: "160px", overflowY: "auto" }}>
              {filtered.length === 0 ? (
                <div className="px-4 py-5 text-center text-xs text-white/25 font-bold">
                  No services found
                </div>
              ) : (
                filtered.map((reg) => (
...
const SubBadge = ({ pool }) => {
  ...
  return active ? (
    ...
    <span className="px-2 py-0.5 rounded-full text-[9px] font-black uppercase border border-white/10 bg-white/5 text-white/30">
      Unpublished
    </span>
  );
};
      ...
      <button
        ...
        className={`flex-1 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
          active === s
            ...
            : "bg-white/5 border border-white/[0.06] text-white/30 hover:text-white/60"
        }`}
      >
        {s}
      </button>
        ...
        <div className="px-6 pt-5 pb-4 border-b border-white/[0.05]">
          <div className="flex items-start justify-between gap-3 mb-4">
            <div className="min-w-0">
              ...
              <p className="font-mono text-[10px] text-white/20 truncate mt-0.5">
                {pool.poolAddress}
              </p>
            </div>
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/30 hover:text-white transition-colors flex-shrink-0 mt-1"
            >
              ✕
            </button>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="p-3 rounded-xl bg-white/[0.03] border border-white/[0.06] text-center">
              <p className="text-[9px] uppercase tracking-widest text-white/25 font-black mb-0.5">
                NGN
              </p>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          {activeSection === "liquidity" && (
            ...
            >
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 rounded-xl text-xs font-black uppercase tracking-widest border transition-all ${
                      liqMode === m
                        ...
                        : "border-white/10 bg-white/5 text-white/25 hover:text-white/50"
                    }`}
                  >
              ...
              {/* Token selector */}
              <div>
                <label className="text-[10px] uppercase tracking-widest text-white/25 font-black block mb-2">
                  Token
                </label>
                      ...
                      <button
                        ...
                        className={`py-3 rounded-xl border transition-all flex flex-col items-center gap-0.5 ${
                          liqAsset === a
                            ...
                            : "border-white/[0.06] bg-white/5 text-white/30 hover:text-white/60"
                        }`}
                      >
    ...
    >
      ...
      {loading ? (
        ...
        >
          ...
          <p className="font-black text-white/30 text-sm mb-1">No pools yet</p>
                ...
                <div className="space-y-2 mb-5">
                  {subFees?.tiers?.map((tier) => (
                    ...
                    >
                      ...
                      <span
                        className={`font-black text-sm ${subTier === tier.months ? "text-salvaGold" : "text-white/40"}`}
                      >
          ...
          <div className="fixed inset-0 z-[80] flex items-center justify-center px-4">
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="font-mono text-[10px] text-white/20 mb-6 break-all">
                  {newlyDeployedPool}
                </p>
                <div className="flex gap-3">
                  <button
          ...
          <div className="fixed inset-0 z-[80] flex items-center justify-center px-4">
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="text-xs text-white/30 mb-1 leading-relaxed">
            ...
            >
              ...
              <div className="px-6 pt-5 pb-4 border-b border-white/[0.05] flex items-center justify-between">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/30 hover:text-white transition-colors"
                >
                  ✕
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-5">
                {renamingPool.poolName && (
                  <div className="flex items-center gap-3 p-3.5 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                    <span className="text-[10px] uppercase font-black text-white/25 tracking-widest flex-shrink-0">
                      Current
                    </span>
