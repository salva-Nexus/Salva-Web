...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    if (savedUser) {
      try {
        ...
        // FIX: Only require username + safeAddress. accountNumber can be null for new users.
        // ownerKey presence is fine too (mid-onboarding state).
  ...
  return (
    <nav className="fixed top-0 w-full z-50 px-0.1 py-1 flex justify-between items-center backdrop-blur-md border-b border-gray-200/10 dark:border-white/5">
      <Link
        to="/"
        style={{
          display: "flex",
      ...
      >
        ...
        />
        <span
          className="text-1.5xl font-black tracking-tighter text-black dark:text-white"
